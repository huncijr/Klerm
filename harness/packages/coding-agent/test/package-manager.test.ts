...
Content`,
		...
		it("should auto-discover root markdown skills from app skill dirs", async () => {
...
Content`,
		...
		it("should resolve project paths relative to the app config directory", async () => {
...
Content`,
	...
	describe("auto-discovered skill metadata", () => {
		it("should use the agent dir as baseDir for user app skills", async () => {
		...
		it("should use the project config dir as baseDir for project app skills", async () => {
	...
	describe(".agents/skills auto-discovery", () => {
		...
		it("should dedupe user skill entries when the app skill dir is a symlink to ~/.agents/skills", async () => {
			const previousHome = process.env.HOME;
			process.env.HOME = tempDir;
	...
	describe("ignore files", () => {
		...
		it("should not apply parent .gitignore to app config auto-discovery", async () => {
	...
	describe("settings source normalization", () => {
		...
		it("should store project local packages relative to the app settings base", () => {
